 ...
 * Description:       Restrofood Liteis an online food ordering and delivery system for WordPress. You can manage your restaurant & other food ordering stuff with Restrofood. It has plenty of amazing features. That helps you to build a successful online business.
 * Version:           1.1.0
 * Author:            ThemeLooks
...
if( !defined( 'RESTROFOODLITE_VERSION' ) ) {
	define( 'RESTROFOODLITE_VERSION', '1.1.0' );
}
...
final class RestroFoodLite {
	...
	public function restrofoodlite_plugin_deactivate() {
		...
		//Delete Restrofood Lite Options
